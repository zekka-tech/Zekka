...
import { EmptyState, EmptyStateNoProjects, EmptyStateError } from '@/components/ui/EmptyState'
import { ErrorState, NotFoundError, ForbiddenError } from '@/components/ui/ErrorState'
...
describe('Accessibility: EmptyState', () => {
  ...
  it('action button is keyboard-accessible', () => {
    render(
      <EmptyStateNoProjects onCreateProject={vi.fn()} />
    )
