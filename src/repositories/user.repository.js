...
class UserRepository {
  ...
  async initializeSchema() {
    try {
      ...
      throw new DatabaseError('Schema initialization failed', { error: error.message });
    }
  }
  ...
  async incrementFailedAttempts(email) {
    try {
      ...
      throw new DatabaseError('Failed to update login attempts', { error: error.message });
    }
  }
  ...
  async resetFailedAttempts(email) {
    try {
      ...
      throw new DatabaseError('Failed to reset login attempts', { error: error.message });
    }
  }
  ...
  async isLocked(email) {
    try {
      ...
      throw new DatabaseError('Failed to check lock status', { error: error.message });
    }
  }
  ...
  async delete(id) {
    try {
      ...
      if (error instanceof NotFoundError) throw error;
      throw new DatabaseError('Failed to delete user', { error: error.message });
    }
  }
